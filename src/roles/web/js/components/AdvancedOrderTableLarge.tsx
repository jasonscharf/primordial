...
export function AdvancedOrderTableLarge(props?: AdvancedOrderTableProps) {
        ...
        : orders.map(row => {
            return (
                <TableRow
                    ...
                    <TableCell align="right">{shortDateAndTime(row.order.opened)}</TableCell>
                    <TableCell align="right">{shortDateAndTime(row.order.closed)}</TableCell>
                    <TableCell align="right">{row.order.quantity.toString()}</TableCell>
