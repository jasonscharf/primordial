...
export default class TradingViewWidget extends React.Component<any> {
  static propTypes = {
  ...
  initWidget = () => {
    ...
    const config = { ...widgetConfig, container_id: this.containerId } as any;
    ...
    /* global TradingView */
    const foo = new TradingView[widgetType](config);
    debugger;
  };
