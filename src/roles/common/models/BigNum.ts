...
export type BigSource = number | string | BigNum;
...
export interface BigNum {
     ...
     */
    round(dp?: number, rm?: RoundingMode): BigNum;
    /**
     ...
     * @throws `NaN` if n is invalid.
     */
    sub(n: BigSource): BigNum;
    /**
     * Returns a Big number whose value is the value of this Big number times n.
     *
     * @throws `NaN` if n is invalid.
     */
    times(n: BigSource): BigNum;
    /**
...
export const BigNum: BigNumConstructor = <any>Big;
